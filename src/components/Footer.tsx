...
const Footer = () => {
    return (
        ...
        '>
            <Layout className='py-6 sm:py-8 bg-[#FF69B4] flex flex-col gap-4 md:flex-row md:items-center md:justify-between'>
                <span className='text-center md:text-left'>{new Date().getFullYear()} &copy; All Rights Reserved.</span>
                <div className='flex items-center justify-center'>
                Built with <span className='text-dark text-2xl px-1'>&hearts;</span>by&nbsp;<Link href="/" className='underline
                underline-offset-2
                '>Brandon</Link>
                </div>
